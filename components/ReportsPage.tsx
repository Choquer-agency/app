...
type ReportTab = "utilization" | "profitability" | "velocity" | "performance" | "revenue" | "forecasting";
...
const PERIOD_TABS: ReportTab[] = ["utilization", "performance"];

export default function ReportsPage({ roleLevel }: { roleLevel?: RoleLevel }) {
