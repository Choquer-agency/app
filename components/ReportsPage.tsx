...
import BillableHoursTab from "./reports/BillableHoursTab";
import MeetingView from "./MeetingView";
import { hasPermission, type RoleLevel, type Permission } from "@/lib/permissions";

type ReportTab = "meetings" | "utilization" | "billable" | "profitability" | "velocity" | "performance" | "revenue" | "forecasting" | "accountability";
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        {activeTab === "billable" && <BillableHoursTab />}
